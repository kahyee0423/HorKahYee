    ...
    return (
        <section className="profile-container">
            ...
            <div className="header-container">
                <img src="/assets/generalPic/Name2.png" className="my-logo" alt="Logo" />
                    <img src="/assets/generalPic/ky.png" className="my-photo" alt="myPicture" />
                    
                <div className="sub-button">
                    <Link to="https://g.dev/kahyee0423" className="link">
                        <img src="/assets/generalPic/google-dev.png" alt="Google Developer" />
                        <span>Google Developer Profile</span>
                    </Link>
                    <Link to="/GCCert" className="link">
                        <img src="/assets/generalPic/googleCloud.png" alt="Google Cloud Skills Boost" />
                        <span>Google Cloud Skill Badge Profile</span>
                    </Link>
                    <Link to="/AlibabaCloud" className="link">
                        <img src="/assets/generalPic/alibabaCloud.png" alt="Alibaba Cloud" />
                        <span>Alibaba Cloud Skills Profile</span>
                    </Link>
                    <Link to="https://www.credly.com/users/kahyee04233" className="link">
                        <img src="/assets/generalPic/credly.png" alt="Credly" />
                        <span>Credly Profile</span>
                    </Link>
                    <Link to="https://www.linkedin.com/in/kahyee0423/" className="link">
                        <img src="/assets/generalPic/linkedin.png" alt="LinkedIn" />
