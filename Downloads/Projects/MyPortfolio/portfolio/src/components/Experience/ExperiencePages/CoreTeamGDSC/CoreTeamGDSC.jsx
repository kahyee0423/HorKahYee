    ...
    <div className="core-team-container">
      <div className="heading-container">
        ...
        <div className="image-quote-wrapper">
          <img src="/assets/CoreTeamGDSCPic/img-04.png" alt="intro pic" className="reveal-image" />
          <div className="text-container">
            <p className="initial-text">Meet Kah Yee</p>
            <blockquote className="reveal-text">
              <p className="quote-text">"She is here with a voracious hunger to explore the arena by the adage 'Less is More'.</p>
              <p>Be that as it may, Kah Yee is more passionate about revealing eras and community</p>
              <p>development in her unique way. Truth be told, it is irrevocably her urge to discover</p>
              <p>how her abilities can revolutionize the planet."</p>
        ...
        <div className="onboarding-sec">
          <div className="image-container-1">
            <img src="/assets/CoreTeamGDSCPic/img-01.png" alt="" />
            <img src="/assets/CoreTeamGDSCPic/img-02.png" alt="" />
          </div>
        ...
        <div className="event-hosted">
          ...
          <div className="emcee-photo">
            <img src="/assets/CoreTeamGDSCPic/img-03.jpg" alt="" />
          </div>
        </div>
        
        <div className="cert-2324">
          <div className="cert-2324-photo">
            <img src="/assets/CoreTeamGDSCPic/gdsc-cert.jpg" alt="" />
          </div>
          <div className="written-text">
